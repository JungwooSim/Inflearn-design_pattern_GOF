...
### Iterator ([link](https://github.com/JungwooSim/Inflearn-design_pattern_GOF/tree/main/design-pattern/src/main/kotlin/structural/iterator))
...
### Mediator ([link](https://github.com/JungwooSim/Inflearn-design_pattern_GOF/tree/main/design-pattern/src/main/kotlin/structural/mediator))

여러 객체들의 소통하는 방법을 캡슐화하는 패턴

여러 컴포넌트간의 결합도를 중재자를 통해 낮출 수 있다

<img src="/design-pattern/img/mediator-uml.png" width="750px">

**장단점**

- 장점
  - 컴포넌트 코드를 변경하지 않고 새로운 중재자를 만들어 사용 가능
...
### State ([link](https://github.com/JungwooSim/Inflearn-design_pattern_GOF/tree/main/design-pattern/src/main/kotlin/structural/state))

객체 내부 상태 변경에 따라 객체의 행동이 달라지는 패턴

상태에 특화된 행동들을 분리해 낼 수 있으며, 새로운 행동을 추가하더라도 다른 행동에 영향을 주지 않는다.

<img src="/design-pattern/img/state-uml.png" width="750px">

**장단점**

- 장점
  - 상태에 따른 동작을 개별 클래스로 옮겨서 관리할 수 있다
  - 기존의 특정 상태에 따른 동작을 변경하지 않고 새로운 상태에 다른 동작을 추가할수 있다
  - 코드 복잡도를 줄일 수 있다
- 단점
  - 복잡도 증가
  
### Strategy ([link](https://github.com/JungwooSim/Inflearn-design_pattern_GOF/tree/main/design-pattern/src/main/kotlin/structural/strategy))

여러 알고리즘을 캡슐화하고 상호 교환 가능하게 만드는 패턴

컨텍스트에서 사용할 알고리즘을 클라이언트에서 선택

<img src="/design-pattern/img/strategy-uml.png" width="750px">

**장단점**

- 장점
  - 새로운 전략을 추가하더라도 기존 코드는 변경하지 않음
  - 상속 대신 위임을 사용할 수 있다
  - 런타임에 전략을 변경 가능하다
- 단점
